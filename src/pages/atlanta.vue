<template>
  <f7-page bg-color="navbar" name="atlanta">
    <f7-navbar back-link="Back">{{clubInformation[9]}}</f7-navbar>
  
      <div class="opacity">
    <f7-block-title ><h3>About {{clubInformation[9]}}</h3></f7-block-title>
    <f7-list>
      <f7-list-item>
...
//// calling firebase data on every page
    async created() {
      ...
      await database.ref("/leagueData/clubs/CL001/")
      .once('value')
      .then(snapshot => {
